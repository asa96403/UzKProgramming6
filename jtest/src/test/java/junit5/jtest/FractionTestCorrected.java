...
import ex2.FractionCorrected;

/**
 * Test class for class fraction using JUnit 5
 * @author aabert
 */
public class FractionTestCorrected {
	@Test
	public void kehrwertKorrekt() {
		FractionCorrected frac = new FractionCorrected(5, 3);
		frac.Kehrwert();
	...
	public void nullInNennerThrowsException() {
		assertThrows(ArithmeticException.class, () -> new FractionCorrected(5, 0));
	}
	...
	public void multiplikationKorrekt(int z1, int n1, int z2,  int n2, int r1, int r2) {
		FractionCorrected frac1 = new FractionCorrected(z1, n1);
		FractionCorrected frac2 = new FractionCorrected(z2, n2);
